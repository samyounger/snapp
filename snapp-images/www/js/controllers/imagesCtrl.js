...
imageController.$inject = ["$scope", "$cordovaDevice", "$cordovaFile", "$ionicPlatform", "$cordovaEmailComposer", "$ionicActionSheet", "ImageService", "FileService"];
function imageController($scope, $cordovaDevice, $cordovaFile, $ionicPlatform, $cordovaEmailComposer, $ionicActionSheet, ImageService, FileService) {
